...
- API version: 0.1
- Build date: 2024-10-04T08:51:19.896289611Z[Etc/UTC]
- Generator version: 7.9.0-SNAPSHOT



This autogenerated project defines an API crate `judge_api_server` which contains:
...
#[async_trait]
impl judge_api_server::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = judge_api_server::server::new(Arc::new(ServerImpl));
